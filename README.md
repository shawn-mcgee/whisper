...
Whisper supports the following types -
...
Untyped composite literals are used to create instances of a composite type. An explicit type can be used to provide a lower bound on the declaration. An untyped composite literal *must* declare a value for *all* fields.
